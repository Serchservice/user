...
class ReferralLinkVerifierLayout extends GetResponsiveView<ReferralLinkVerifierController> {
  static String get route => "/join_the_serch_user_app";
  ReferralLinkVerifierLayout({super.key});
