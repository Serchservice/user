...
class RequestedTripViewController extends GetxController {
  final TripResponse trip;
  RequestedTripViewController({required this.trip});

  final state = RequestedTripViewState();
