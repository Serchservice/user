...
class GuestRequestedTripView extends StatelessWidget {
  final TripResponse trip;
  const GuestRequestedTripView({super.key, required this.trip});

  static void open(TripResponse trip) {
    Navigate.bottomSheet(
      sheet: GuestRequestedTripView(trip: trip),
      route: "/connection/trip/request?id=${trip.id}",
      isScrollable: true
    );
  }
  ...
  Widget build(BuildContext context) {
    return CurvedBottomSheet(
      ...
      child: GetBuilder<GuestRequestedTripViewController>(
        init: GuestRequestedTripViewController(trip: trip),
        builder: (controller) {
          return Obx(() {
