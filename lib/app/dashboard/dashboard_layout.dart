      ...
      children: [
        Row(
          ...
          children: [
            ...
            if(icon != null) ...[
              Icon(icon, color: CommonColors.lightTheme, size: 25)
            ]
          ],
        ),
        ...
        if(image.isNotEmpty) ...[
          Row(
            ...
            children: [
              ...
              Expanded(child: SText(text: content, size: Sizing.font(15), color: CommonColors.lightTheme)),
            ],
          )
        ],
        if(image.isEmpty) ...[
          SText(text: content, size: Sizing.font(15), color: CommonColors.lightTheme)
        ]
      ],
    )
  );
