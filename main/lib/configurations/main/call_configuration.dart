...
class CallConfiguration extends GetxController {
  ...
  CallConfiguration({this.videoClient, this.notification, this.from});
  ...
  void _tryConsumingIncomingCallFromTerminatedState() {
    if (Navigate.navigatorKey.currentContext == null) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
        consumeIncomingCall(uuid: from, channel: notification?.callCid);
      });
    } else {
  ...
  static void disposeEngines(String channel) {
    EventController.data.removeCallByChannel(channel);
    remoteNotificationAction.dismissGroupedNotifications(channel);
