...
class SharedLinkVerifierLayout extends GetResponsiveView<SharedLinkVerifierController> {
  static String get route => "/invite/shared";
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: controller.buttons.map((button) => LoadingButton(
                      text: button.header,
                  ...
                  if(Database.isLoggedIn) ...[
                    ...
                    LoadingButton(
                      ...
                      textColor: Theme.of(context).scaffoldBackgroundColor,
                      onClick: () => GuestSignupWithUserAccountLayout.to(link: controller.state.data.value.link),
                    )
                  ],
                ]
              )
