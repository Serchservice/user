...
class GuestSignupController extends GetxController {
  GuestSignupController();
  final state = GuestSignupState();
      ...
      if(state.gender.value.isEmpty) {
        ...
        if(response.isOk) {
          ...
          if(guest.confirmed) {
            ...
            GuestEmailVerificationLayout.off(GuestEmailVerification(emailAddress: guest.emailAddress, name: guest.name));
          }
        } else {
