      ...
      children: [
        ...
        Expanded(
          child: Center(
            child: Column(
              children: [
                Expanded(child: Image.asset(Media.onboard1, width: MediaQuery.sizeOf(context).width)),
                const SizedBox(height: 20),
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    SText(text: _displayedText, size: size, color: color),
                    if (_showCursor) ...[
                      SText(text: "|", size: size, color: color),
                    ]
                  ],
                ),
              ],
