...
class SearchResultFilterSheet extends StatefulWidget {
  final double radius;
  ...
  static void open({
    ...
    sheet: SearchResultFilterSheet(radius: radius, list: list, onUpdate: onUpdate, selected: selected),
    isScrollable: true,
    safeArea: false,
    route: "/home/result/filter"
  );

  @override
  State<SearchResultFilterSheet> createState() => _SearchResultFilterSheetState();
}

class _SearchResultFilterSheetState extends State<SearchResultFilterSheet> {
          ...
          LoadingButton(
            ...
            onClick: () {
              ...
              widget.onUpdate.call(
                ...
                selectedIndex != widget.selected ? selectedIndex : null
              );
            },
          )
        ],
