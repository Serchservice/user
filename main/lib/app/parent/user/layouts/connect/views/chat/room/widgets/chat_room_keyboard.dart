...
class ChatRoomKeyboard extends StatelessWidget {
  final ChatRoomController controller;

  const ChatRoomKeyboard({super.key, required this.controller});
    ...
    return Obx(() {
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            if(isSwiped) ...[
              ChatRoomMessageToReply(
                reply: controller.state.reply.value,
                onCancelled: () => controller.cancelReplyMessage()
              )
            ],
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  icon: Icon(
                    ...
                    color: controller.state.showSendButton.value ? Theme.of(context).scaffoldBackgroundColor : CommonColors.hint,
