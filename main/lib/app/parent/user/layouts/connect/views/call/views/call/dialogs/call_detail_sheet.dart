...
class CallDetailSheet extends StatelessWidget {
  ...
  const CallDetailSheet({super.key, required this.controller, this.showInvite = false});

  static void open({required CallController controller, bool showInvite = false}) {
    Navigate.bottomSheet(
      sheet: CallDetailSheet(controller: controller, showInvite: showInvite),
      route: "/connect/call/${controller.state.call.value.channel}/details",
      isScrollable: true,
      safeArea: false
    );
  }
