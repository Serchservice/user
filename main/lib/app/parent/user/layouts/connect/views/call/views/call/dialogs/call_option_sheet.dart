...
class CallOptionSheet extends StatelessWidget {
  ...
  static void open({required String id, required String name, required String avatar}) {
    Navigate.bottomSheet(
      ...
      route: "/connect/call/start/options"
    );
  }
          ...
          GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return PreferenceSelectorItem(
                ...
                onTap: () {
                  if(index == 0) {
                    CallLayout.call(name: name, avatar: avatar, user: id, type: CallType.voice);
                  } else if(option.index == 1) {
                    CallLayout.call(name: name, avatar: avatar, user: id, type: CallType.tip2fix);
                  }
                },
                child: Column(
                  children: [
