...
class BiometricsAuthLayout extends GetResponsiveView<BiometricsAuthController> {
  ...
  static const String loginRoute = "/auth/login/biometrics";
  static const String route = "/centre/privacy-and-security/biometrics/settings";
  ...
  static Future<T?>? off<T>(bool hasBiometrics) {
    return Navigate.off(route, parameters: {"login": "true", "has_biometrics": hasBiometrics.toString()});
  }
