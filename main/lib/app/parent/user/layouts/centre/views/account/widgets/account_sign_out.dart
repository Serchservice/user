...
class AccountSignOut extends StatefulWidget {
  const AccountSignOut({super.key});

  @override
  State<AccountSignOut> createState() => _AccountSignOutState();

  static void open() => Navigate.bottomSheet(
    sheet: const AccountSignOut(),
    route: "/centre/account/sign-out",
    background: Colors.transparent,
    isScrollable: true
  );
}

class _AccountSignOutState extends State<AccountSignOut> {
