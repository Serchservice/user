...
class WalletTransactionView extends StatelessWidget {
  ...
  const WalletTransactionView({super.key, required this.transaction});

  static void open({required Transaction transaction}) => Navigate.bottomSheet(
    sheet: WalletTransactionView(transaction: transaction),
    route: "/centre/wallet/transactions/${transaction.data.id}",
    isScrollable: true
  );
