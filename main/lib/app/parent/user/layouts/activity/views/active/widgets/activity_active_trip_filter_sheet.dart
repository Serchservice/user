...
class ActivityActiveTripFilterSheet extends StatelessWidget {
  final ActivityActiveController controller;
  const ActivityActiveTripFilterSheet({super.key, required this.controller});

  static void open({required ActivityActiveController controller}) => Navigate.bottomSheet(
    sheet: ActivityActiveTripFilterSheet(controller: controller),
    isScrollable: true,
