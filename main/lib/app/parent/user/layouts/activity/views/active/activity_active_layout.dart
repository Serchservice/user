...
class ActivityActiveLayout extends GetResponsiveView<ActivityActiveController> {
  ActivityActiveLayout({super.key});
                    ...
                    IconButton(
                      onPressed: () {
                        if(controller.state.filterIndex.value == 0) {
                          ActivityActiveTripFilterSheet.open(controller: controller);
                        } else {
                          ActivityActiveScheduleFilterSheet.open(controller: controller);
                        }
                      },
        ...
        return PagedListView<int, TripResponse>(
          ...
          builderDelegate: PagedChildBuilderDelegate<TripResponse>(
            itemBuilder: (context, trip, index) {
              return ActivityTripItem(trip: trip, onTap: ActivityActiveTripView.open, showShared: true, showTimeline: true);
            },
