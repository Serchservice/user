...
class ActivityHistoryTripItemSheet extends StatelessWidget {
  final TripResponse trip;
  const ActivityHistoryTripItemSheet({super.key, required this.trip});

  static void open(TripResponse trip) => Navigate.bottomSheet(
    sheet: ActivityHistoryTripItemSheet(trip: trip),
  ...
  Widget build(BuildContext context) {
    return CurvedBottomSheet(
      safeArea: true,
      child: GetBuilder<ActivityHistoryTripItemSheetController>(
        init: ActivityHistoryTripItemSheetController(trip: trip),
        builder: (controller) {
          return Obx(() {
