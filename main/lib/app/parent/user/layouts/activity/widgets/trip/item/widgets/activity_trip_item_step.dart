...
class ActivityTripItemStep extends StatefulWidget {
  final String header;
  ...
  @override
  State<ActivityTripItemStep> createState() => _ActivityTripItemStepState();
}

class _ActivityTripItemStepState extends State<ActivityTripItemStep> {
  ...
  @override
  void didUpdateWidget(covariant ActivityTripItemStep oldWidget) {
