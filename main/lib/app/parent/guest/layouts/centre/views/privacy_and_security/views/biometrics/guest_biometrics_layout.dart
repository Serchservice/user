...
class GuestBiometricsLayout extends GetResponsiveView<GuestBiometricsController> {
  static const String route = "/guest/centre/privacy-and-security/biometrics";

  GuestBiometricsLayout({super.key});
